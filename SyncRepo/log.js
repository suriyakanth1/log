...
function getWorkflowRunLog(owner, repo, runId) {
    return __awaiter(this, void 0, void 0, function () {
        var apiUrl, response, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    apiUrl = "https://api.github.com/repos/".concat(owner, "/").concat(repo, "/actions/runs/").concat(runId, "/logs");
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error('Error fetching workflow run log:', error_1);
                    throw error_1;
